# Jaebeom Lee | LLM-based Agent Specialist
...
* **Information Retrieval: Vector RAG**, Graph RAG, Hybrid Search
...
### Language & Certs
* **Multilingual**: 🇰🇷 Korean (Native), 🇯🇵 **Japanese (JLPT N1)**, 🇺🇸 **English (TOEIC 840)**.
* **Certification: Big Data Analysis Engineer** (빅데이터분석기사)
